        ...
        {open && (
          <>
            ...
            <motion.div
              ...
              exit={{ x: "100%" }}
              transition={{ duration: 0.3 }}
              className="fixed top-0 right-0 w-[60%] h-full bg-white text-[#AF1024] flex flex-col items-center gap-6 pt-20 text-lg z-50 shadow-lg"
            >
              {/* Close Button */}
              ...
              <div className="flex gap-2 justify-center mb-6 hover:cursor-pointer" onClick={() => setOpen(false)}>
                ...
                <p className="text-[#AF1024] font-bold text-[24px] pt-[7px]">Baymax</p>
              </div>
              <p onClick={() => setOpen(false)} className="cursor-pointer hover:font-bold hover:text-[24px] transition-all">AI Assistant</p>
              <p onClick={() => setOpen(false)} className="cursor-pointer hover:font-bold hover:text-[24px] transition-all">Schedule Call</p>
              <p onClick={() => setOpen(false)} className="cursor-pointer hover:font-bold hover:text-[24px] transition-all">About Us</p>
              <p onClick={() => setOpen(false)} className="cursor-pointer hover:font-bold hover:text-[24px] transition-all">Get Started</p>
            </motion.div>
          </>
        )}
      </AnimatePresence>
